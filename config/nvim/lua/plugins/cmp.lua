...
local source_mapping = {
  npm = yozora.icons.terminal .. "NPM",
  cmp_tabnine = yozora.icons.light,
  Copilot = yozora.icons.copilot,
  Codeium = yozora.icons.codeium,
  nvim_lsp = yozora.icons.stack .. "LSP",
  buffer = yozora.icons.buffer .. "BUF",
  nvim_lua = yozora.icons.bomb,
  luasnip = yozora.icons.snippet .. "SNP",
  calc = yozora.icons.calculator,
  path = yozora.icons.folderOpen2,
  treesitter = yozora.icons.tree,
  zsh = yozora.icons.terminal .. "ZSH",
}
